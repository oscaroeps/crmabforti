...
export class EmailService {
  ...
  registrar_lista_contacto(data: any, token: any): Observable<any> {
    let headers = new HttpHeaders({ 'Content-Type': 'application/json', 'Authorization': token });
    return this._http.post(this.url + 'registrar_lista_contacto', data, { headers: headers });
  }
  ...
  crear_campaing(data: any, token: any): Observable<any> {
    let headers = new HttpHeaders({ 'Content-Type': 'application/json', 'Authorization': token });
    return this._http.post(this.url + 'crear_campaing', data, { headers: headers });
  }
