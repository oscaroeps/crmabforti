...
@Component({
  selector: 'app-llamadas-prospecto',
  templateUrl: './llamadas-prospecto.component.html',
  styleUrls: ['./llamadas-prospecto.component.css']
})
export class LlamadasProspectoComponent implements OnInit {
  ...
  registrar() {
    /*     console.log(this.time || this.time != undefined || this.time != null);
     */
    if (this.time) {
