...
@Component({
  selector: 'app-tareas-prospecto',
  templateUrl: './tareas-prospecto.component.html',
  styleUrls: ['./tareas-prospecto.component.css']
})
export class TareasProspectoComponent implements OnInit {
  ...
  init_data() {
    this._clienteService.listar_tareas_prospeccion_admin(this.id, this.token).subscribe(
      response => {
