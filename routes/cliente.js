...
app.post('/registro_prospecto_admin', auth.auth, clienteController.registro_prospecto_admin);
...
app.put('/cambiar_verify_cliente_admin/:id', auth.auth, clienteController.cambiar_verify_cliente_admin);
